        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="text-slid-box">
                    <div id="offer-box" class="carouselTicker">
                        <ul class="offer-box">
                            <li>
                                <i class="fab fa-opencart"></i> Giảm giá 10% khi mua 2 đôi giày
                            </li>
                            <li>
                                <i class="fab fa-opencart"></i>Nhân ngầy 30/4-01/05 giảm giá toàn bộ sản phẩm giày adidas
                            </li>
                            <li>
                                <i class="fab fa-opencart"></i>Tặng thêm Voucher 500k khi mua đơn hàng 2500k trở lên 
                            </li>
                            <li>
                                <i class="fab fa-opencart"></i>giảm giá 20% khi mua combo 2 đôi trở lên
                            </li>
                            <li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="right-phone-box">
                    <p>Liên hệ: <a href="#"> +(84) 0123456789</a></p>
                </div>
                <div class="our-link">
                    <ul>
                        @if(Auth::check())
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/home') }}"><img width="214px" src="{{asset('front_assets/images/logo_1.jpg')}}" class="logo" alt=""></a>
            </div>
