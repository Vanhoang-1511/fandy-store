        ...
        <ul class="slides-container">
            ...
            <li class="text-left" style="height: auto;">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong style="color:#FFFF33">{{$slide->content}}</strong></h1>
            ...
            <div class="row special-list">
                ...
                <div class="col-lg-3 col-md-6 special-grid top-hot">
                    <div class="products-single fix">
                        ...
                        <div class="why-text">
                            <h4>
                                <a href="{{url('/product-detail?id='.$topHot->id)}}">{{ Illuminate\Support\Str::limit($topHot->name, 23) }}</a>
                            </h4>
                ...
                <div class="col-lg-3 col-md-6 special-grid top-new">
                    <div class="products-single fix">
                        ...
                        <div class="why-text">
                            <h4>
                                <a href="{{url('/product-detail?id='.$topNew->id)}}">{{ Illuminate\Support\Str::limit($topNew->name, 23) }}</a>
                            </h4>
                ...
                <div class="col-lg-3 col-md-6 special-grid top-sale">
                    <div class="products-single fix">
                        ...
                        <div class="why-text">
                            <h4>
                                <a href="{{url('/product-detail?id='.$topSale->id)}}">{{ Illuminate\Support\Str::limit($topSale->name, 23) }}</a>
                            </h4>
