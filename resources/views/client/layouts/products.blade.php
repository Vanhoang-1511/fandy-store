...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Giày Dép Fandy Store Tận tâm uy tín, sản phẩm chất lượng, chăm sóc khách hàng 24/24</h2>
                    <h2>Điện thoại: 0905912028</h2>
                    <ul class="breadcrumb">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        ...
                                                        <div class="why-text">
                                                            <a href="{{url('/product-detail?id='.$item->id)}}"><h4>{{Illuminate\Support\Str::limit($item->name, 25)}}</h4></a>
